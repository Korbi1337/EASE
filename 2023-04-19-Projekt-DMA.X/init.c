...
//6. Input change notification
 ...
 //7. Timers
    ...
    U1MODEbits.USIDL =0b0;      //UART continue in idle mode 
    U1MODEbits.IREN = 0b1;      //encoder and decoder enable
    U1MODEbits.UEN=0b00;        //Tx and Rx aktiv, latch für uxcts und rxcts
    U1MODEbits.RXINV=0b0;       //Idle State 1
