...
volatile uint16_t maxtime=65000;      //zählerüberlauf verhindern
...
volatile uint16_t LEDD5_FLAG = 0;
volatile uint16_t zahl_LCD = 10;
...
int main(void)
{
    ...
    uint16_t entprellzeit=6;      //Entprellzeit in ms
    uint16_t Zahl=5;
